...
const FrontendProductCard = () => {
  return (
    <div className="h-120 w-80 bg-[#E6F1F1] m-3.5 rounded-4xl p-4.5 border-2">
      <div className="h-40 w-70 bg-amber-200 rounded-4xl">
        <img
          src="https://img.freepik.com/premium-psd/bowl-almonds-isolated-transparent-background_812337-3610.jpg"
          alt="image"
